...
from . import prompts_complete, safety, schemas
    ...
    async def run(self, task: str, plan: Dict) -> ExecutionResult:
        ...
        for step in range(1, self.cfg.MAX_STEPS + 1):
            ...
            if self.observation_mode == OBSERVATION_MODE_BROWSER:
                ...
                system_prompt = prompts_complete.EXECUTION_SYSTEM
                from browser.observation_provider import format_elements_for_prompt
                user_prompt = prompts_complete.build_execution_user(
                    task = task,
                    plan = plan_steps,
                    current_step = step,
